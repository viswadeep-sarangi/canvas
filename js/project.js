  ...
  var window_size_in_ms=50;
  var sampling_rate_in_ms=2; 

  // Declaring global variables
  var just_a_constant_to_multiple_with_pop_value=50;
  var mouse = {x: 0, y: 0};
...
var POperate = function() {
	...
	current_pOperated_value_X=(just_a_constant_to_multiple_with_pop_value*current_pOperated_value_X)/(canvas.width*window_size_in_points);
	current_pOperated_value_Y=(just_a_constant_to_multiple_with_pop_value*current_pOperated_value_Y)/(canvas.height*window_size_in_points);

	// var temp_current_pOperated_value_X=(just_a_constant_to_multiple_with_pop_value*current_pOperated_value_X)/(canvas.width*window_size_in_points);
	// var temp_current_pOperated_value_Y=(just_a_constant_to_multiple_with_pop_value*current_pOperated_value_Y)/(canvas.height*window_size_in_points);

	// current_pOperated_value_X=(current_pOperated_value_X+temp_current_pOperated_value_X)/2;
	// current_pOperated_value_Y=(current_pOperated_value_Y+temp_current_pOperated_value_Y)/2;
